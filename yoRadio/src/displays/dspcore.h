...
#elif DSP_MODEL==DSP_ST7789_76 || DSP_MODEL==DSP_ST7789_170 // https://k210.org/images/content/uploads/yoradio/ST7789_76.mp4
  #define TIME_SIZE           35
  #define PSFBUFFER
  #include "displayST7789.h"
...
#elif DSP_MODEL==DSP_GC9A01          // 240x240 1.28"
  #define TIME_SIZE          52
  #define PSFBUFFER
  #include "displayGC9A01.h"

#elif DSP_MODEL==DSP_GC9A01_I80          // 240x240 1.28"
  #define TIME_SIZE          52
  #define PSFBUFFER
